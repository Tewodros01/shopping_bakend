        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        conn = _a.sent();
                        sql = "INSERT INTO users ( firstname, lastname ,password_digit) VALUES($1, $2, $3) RETURNING *";
                        hash = bcrypt_1.default.hashSync(user.password_digit + pepper, parseInt(saltRounds));
                    ...
                    case 3:
                        err_3 = _a.sent();
                        throw new Error("Could not create user ".concat(err_3));
                    case 4: return [2 /*return*/];
                }
            });
        });
